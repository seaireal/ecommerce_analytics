...
=======
nn <- nn.train(x_train, y_train, hidden = c(50), activationfun="sigm", output="sigm")
yy = nn.predict(nn, x_test)
print(head(yy))

predictions = nn.predict(nn, x_test) 
error_rate = nn.test(nn, x_test, y_test, t=0.5)
...
>>>>>>> e1556af4352482a4b347e251997e9159de7033cb
